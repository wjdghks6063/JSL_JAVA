...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%> <!--jstl을 사용 if같은 기능 사용가능 -->
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%> <!--자바의 length나 substring같은 기능 사용가능 -->
<%@ page import="common.*"  %>
<!doctype html>
<html lang="ko">
 <head>
  ...
  <title>JSL인재개발원 이정환</title>
 <!--   작동이 되지 않아 아래 있는 폰트어썸으로 사용
 <link href="/servlet_mvc_homepage/css/font-awesome.min.css" rel="stylesheet"> 
 -->
  <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css" rel="stylesheet">
  <link href="/servlet_mvc_homepage/css/font-awesome.min.css" rel="stylesheet">
  <link href="/servlet_mvc_homepage/css/common.css" rel="stylesheet">
  <link href="/servlet_mvc_homepage/css/layout.css" rel='stylesheet'>
  <!--
  	jquery언어 사용법
  ...
  <script src="/servlet_mvc_homepage/js/jquery-1.8.1.min.js"></script>
  <script src="/servlet_mvc_homepage/js/common.js"></script>
  
    <script type="text/javascript">
	  function goJoinForm() {
		  index.t_gubun.value="goJoinForm";
		  index.method="post";
		  index.action="Member";
		  index.submit();
	  }
 ...
 <body>
 <form name="index">
 	<input type="hidden" name="t_gubun"> <!-- value의 값이 바뀐다면 function에 value값을 넣어주면된다. -->
 </form>
 <!-- 
 웹문서 만들기 기본 공식
 ...
 -->
	...
	<div class="top_navigation">
		...
		<header class="header">
			...
			<nav class="top_right">
				<ul>
					<c:if test="${session_name eq null}"> <!-- null 방식 -->
						<li class="first"><a href="Member">로그인</a></li>
					</c:if>	
					<c:if test="${not empty session_name}"> <!-- empty 방식 -->
						<li class="first">${session_name}...</li>
						<li class="first"><a href="javascript:goLogout()">로그아웃</a></li>
					</c:if>		
					
					<li><a href="javascript:goJoinForm()">회원가입</a></li>
			...
			<div class="gnb_group">
				<h1 class="logo"><a href="Index"><img src="images/jsl_logo_f.png"></a></h1>
				<nav class="gnb">
					<ul class="nav_1depth">
